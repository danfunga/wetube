...
export const join= ( request, response )=> response.render("join",  {pageTitle:"Join"} );
export const login = (request, response )=> response.render("login",  {pageTitle:"Login"} );
export const logout = (request, response )=> response.render("logout",  {pageTitle:"Logout"} );
